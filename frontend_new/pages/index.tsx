...
export default function Main() {
  return (
    <>
      ...
      {/* Footer */}
      <footer className="w-full border-t py-6 mt-16 items-center">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <FaBaby className="h-5 w-5 text-blue-500" />
              <p className="text-sm text-muted-foreground">© 2025 NeoGrow - Todos os direitos reservados.</p>
            </div>
